...
counting_regions = [
    {
        ...
        "polygon": Polygon([(150, 100), (400, 80), (650, 400), (400, 550), (250, 350)]),  # Polygon points
        "counts": 0,
        "dragging": False,
    ...
    },
    {
        ...
        "polygon": Polygon([(500, 90), (600, 30), (1140, 200), (1000, 450)]),  # Polygon points
        "counts": 0,
        "dragging": False,
        "region_color": (37, 255, 225),  # BGR Value
        "text_color": (0, 0, 0),  # Region Text Color
...
def run(
    ...
    while videocapture.isOpened():
        ...
        # Extract the results
        results = model.track(frame, persist=True, classes=classes, conf=0.1)
